		...
		return array(
			array(
				array(
					...
					array(
						'param1' => array('type' => 'boolean', 'description' => 'description1'),
						'param2' => array('type' => 'string', 'description' => 'description2')
					)
				),
				"	/**\n	 * This is my comment from something or\n	 * other\n	 * \n	 * @param boolean param1 description1\n	 * @param string param2 description2\n	 * @author Matt Button <matthew@sigswitch.com>\n	 */",
			),
		);
	}
